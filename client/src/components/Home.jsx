...
const Homepage = () => {
  return (
    <main className="my-10 md:my-14 3xl:my-16">
      ...
      <p className="px-4 py-4 text-sm font-bold sm:text-base 3xl:text-lg dark:font-normal border-3 border-dark dark:border-light sm:p-5 rounded-3xl font-abeezee md:w-10/12 2xl:w-3/4">
